...
// This uses the API Key and Project ID directly, which is more reliable for project scoping here.
...
async function startServer() {
  ...
  app.post('/api/send-verification', async (req, res) => {
    ...
    try {
      console.log('Attempting to store verification in Firestore for:', email);
      // Store in Firestore using Client SDK
      ...
      console.log('Verification stored successfully with ID:', docRef.id);
